# Revision de capa: public_transport

Usa el entorno `exposome` y ejecuta todo desde la raiz del repo.

## Objetivo
Revisar si `Transporte publico` esta lista para marcarse como `checked` en `docs/exposome_status.csv`.

## Archivos principales
- Script: `exposome run --study santiago_communes --layers public_transport --resume`
...
- Metodologia: `docs/public_transport_methodology.md`
- Figura/mapa: `data/processed/cl/santiago/santiago_communes/public_transport/public_transport_santiago_4panel.png`
