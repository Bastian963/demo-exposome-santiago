# Revision de capa: alan

Usa el entorno `exposome` y ejecuta todo desde la raiz del repo.

## Objetivo
Revisar si `Luz artificial nocturna` esta lista para marcarse como `checked` en `docs/exposome_status.csv`.

## Archivos principales
- Script: `exposome run --study santiago_communes --layers alan --resume`
...
- Metodologia: `docs/alan_methodology.md`
- Figura/mapa: `data/processed/cl/santiago/santiago_communes/alan/alan_santiago_4panel.png`
