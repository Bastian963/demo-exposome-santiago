# Revision de capa: air_quality_satellite

Usa el entorno `exposome` y ejecuta todo desde la raiz del repo.

## Objetivo
Revisar si `Calidad del aire satelital` esta lista para marcarse como `checked` en `docs/exposome_status.csv`.

## Archivos principales
- Script: `exposome run --study santiago_communes --layers air_quality_satellite --resume`
...
- Metodologia: `docs/plan_a_plus_methodology.md`
- Figura/mapa: `data/processed/cl/santiago/santiago_communes/air_quality_satellite/air_quality_satellite_santiago_4panel.png`
