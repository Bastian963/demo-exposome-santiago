# Revision de capa: food_environment

Usa el entorno `exposome` y ejecuta todo desde la raiz del repo.

## Objetivo
Revisar si `Entorno alimentario` esta lista para marcarse como `checked` en `docs/exposome_status.csv`.

## Archivos principales
- Script: `exposome run --study santiago_communes --layers food_environment --resume`
...
- Metodologia: `docs/food_environment_methodology.md`
- Figura/mapa: `data/processed/cl/santiago/santiago_communes/food_environment/food_environment_santiago_4panel.png`
