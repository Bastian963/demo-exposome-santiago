# Revision de capa: sleep_context

Usa el entorno `exposome` y ejecuta todo desde la raiz del repo.

## Objetivo
Revisar si `Contexto sueno-circadiano` esta lista para marcarse como `checked` en `docs/exposome_status.csv`.

## Archivos principales
- Script: `exposome run --study santiago_communes --layers sleep_context --resume`
...
- Metodologia: `docs/sleep_context_methodology.md`
- Figura/mapa: `data/processed/cl/santiago/santiago_communes/sleep_context/sleep_context_santiago.png`
