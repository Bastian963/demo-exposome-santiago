# Revision de capa: precipitation

Usa el entorno `exposome` y ejecuta todo desde la raiz del repo.

## Objetivo
Revisar si `Precipitacion CHIRPS` esta lista para marcarse como `checked` en `docs/exposome_status.csv`.

## Archivos principales
- Script: `exposome run --study santiago_communes --layers precipitation --resume`
...
- Figura/mapa: `data/processed/cl/santiago/santiago_communes/precipitation/precipitation_santiago_4panel.png`
