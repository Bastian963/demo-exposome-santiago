# Revision de capa: pobreza_sae

Usa el entorno `exposome` y ejecuta todo desde la raiz del repo.

## Objetivo
Revisar si `Pobreza comunal SAE` esta lista para marcarse como `checked` en `docs/exposome_status.csv`.

## Archivos principales
- Script: `exposome run --study santiago_communes --layers pobreza_sae --resume`
...
- Metodologia: `docs/pobreza_sae_methodology.md`
