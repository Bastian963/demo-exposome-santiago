# Revision de capa: wind

Usa el entorno `exposome` y ejecuta todo desde la raiz del repo.

## Objetivo
Revisar si `Wind` esta lista para marcarse como `checked` en `docs/exposome_status.csv`.

## Archivos principales
- Script: `exposome run --study santiago_communes --layers wind --resume`
...
- Metodologia: `docs/wind_methodology.md`
- Figura/mapa: `data/processed/cl/santiago/santiago_communes/wind/wind_santiago_4panel.png`
