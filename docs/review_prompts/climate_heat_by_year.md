# Revision de capa: climate_heat_by_year

Usa el entorno `exposome` y ejecuta todo desde la raiz del repo.

## Objetivo
Revisar si `Climate Heat By Year` esta lista para marcarse como `checked` en `docs/exposome_status.csv`.

## Archivos principales
- Script: `python scripts/run_climate_heat_by_year.py`
- CSV: `data/processed/santiago_climate_heat_by_year.csv`
- GeoJSON: `data/processed/santiago_climate_heat_by_year.geojson`
- Metadata: `data/processed/santiago_climate_heat_by_year_metadata.json`
- Metodologia: `docs/climate_heat_methodology.md`
