# Revision de capa: precipitation_spi

Usa el entorno `exposome` y ejecuta todo desde la raiz del repo.

## Objetivo
Revisar si `Sequias SPI` esta lista para marcarse como `checked` en `docs/exposome_status.csv`.

## Archivos principales
- Script: `exposome run --study santiago_communes --layers precipitation_spi --resume`
...
- Figura/mapa: `data/processed/cl/santiago/santiago_communes/precipitation_spi/precipitation_spi_santiago_4panel.png`
