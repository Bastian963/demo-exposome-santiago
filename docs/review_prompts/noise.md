# Revision de capa: noise

Usa el entorno `exposome` y ejecuta todo desde la raiz del repo.

## Objetivo
Revisar si `Ruido urbano` esta lista para marcarse como `checked` en `docs/exposome_status.csv`.

## Archivos principales
- Script: `exposome run --study santiago_communes --layers noise --resume`
...
- Metodologia: `docs/noise_methodology.md`
- Figura/mapa: `data/processed/cl/santiago/santiago_communes/noise/noise_santiago_4panel.png`
