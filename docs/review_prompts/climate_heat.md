# Revision de capa: climate_heat

Usa el entorno `exposome` y ejecuta todo desde la raiz del repo.

## Objetivo
Revisar si `Clima y calor urbano` esta lista para marcarse como `checked` en `docs/exposome_status.csv`.

## Archivos principales
- Script: `exposome run --study santiago_communes --layers climate_heat --resume`
...
- Figura/mapa: `data/processed/cl/santiago/santiago_communes/climate_heat/climate_heat_santiago_pub.png`
