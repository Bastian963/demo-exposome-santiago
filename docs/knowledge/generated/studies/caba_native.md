...
- Configuración: [caba_native.yaml](../../../../config/studies/caba_native.yaml)
...
```bash
exposome run --study caba_native --dry-run
exposome run --study caba_native --resume
exposome publish --study caba_native
exposome verify --study caba_native
```
