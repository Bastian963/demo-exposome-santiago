...
---
type: exposome-study
study_id: "sao_paulo_native"
location: "br/sao_paulo"
hidden: true
generated: true
---

# Estudio: sao_paulo_native

- Configuración: [sao_paulo_native.yaml](../../../../config/studies/sao_paulo_native.yaml)
...
```bash
exposome run --study sao_paulo_native --dry-run
exposome run --study sao_paulo_native --resume
exposome publish --study sao_paulo_native
exposome verify --study sao_paulo_native
```
