...
---
type: exposome-study
study_id: "medellin_native"
location: "co/medellin"
hidden: true
generated: true
---

# Estudio: medellin_native

- Configuración: [medellin_native.yaml](../../../../config/studies/medellin_native.yaml)
...
```bash
exposome run --study medellin_native --dry-run
exposome run --study medellin_native --resume
exposome publish --study medellin_native
exposome verify --study medellin_native
```
