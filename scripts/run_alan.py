"""CLI entrypoint for the ALAN (artificial light at night) pipeline."""
...
from exposome.alan import build_alan_layer  # noqa: E402
...
def run(
    ...
    """Fetch VIIRS night-time-light data and export commune-level zonal stats."""
    build_alan_layer(city=city, cache_dir=cache_dir, out_dir=out_dir)
