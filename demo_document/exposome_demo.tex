...
\begin{description}[leftmargin=0pt,labelsep=0.5em,itemsep=1.5pt,font=\ttfamily\small]
  ...
  \item[data/processed/*\_exposome\_rm\_santiago.\{csv,geojson\}] per-factor commune indicators as a table and a GIS layer.
  \item[figures/*\_santiago\_pub.png \textnormal{,} maps/*\_santiago.html] publication-quality static map and interactive web map per factor.
  \item[scripts/build\_master\_exposome.py] joins all layers and writes the master CSV, GeoJSON and metadata in the processed-data folder ($52\times43$).
